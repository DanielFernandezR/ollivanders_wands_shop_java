...
/**
 * Código del main proporcionado por el tutor
 */
...
public class App {
	public static void main(String[] args) {
		...
		/**
		 * Tedious but necessary, Ollivanders types the just arrived items and adds them
		 * to the inventory.
		 */

		List<Updateable> items = List.of(new NormalItem("+5 Dexterity Vest", 10, 20), new AgedBrie("Aged Brie", 2, 0),
				new NormalItem("Elixir of the Mongoose", 5, 7), new Sulfuras("Sulfuras, Hand of Ragnaros", 0, 80),
		...
		/**
		 * New item type Conjured just arrived. Add it to the inventory: polimorphism in
		 * action
		 */
